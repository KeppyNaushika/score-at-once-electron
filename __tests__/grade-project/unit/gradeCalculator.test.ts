...
vi.mock("@/electron-src/lib/prisma/client", () => ({
  default: {
    ...
    projectPage: { findMany: vi.fn().mockResolvedValue([]) },
    projectStudent: { findMany: vi.fn().mockResolvedValue([]) },
  },
}))
...
function buildGradeProject(
  ...
  return {
    ...
    gradeProjectClasses: overrides.gradeProjectClasses ?? [],
  }
}
