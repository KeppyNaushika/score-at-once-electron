...
export function createMockWizard(
  ...
  return {
    ...
    executeImport: vi.fn().mockResolvedValue({
      ...
      summary: {
        created: { students: 1, classes: 0, users: 0, pages: 0, regions: 0, scores: 4, annotations: 0, subtotalGroups: 0, masterImages: 0, answerSheetImages: 0 },
        ...
        unchanged: { students: 2, classes: 0, users: 0, pages: 0, regions: 0, scores: 8, annotations: 0, subtotalGroups: 0, masterImages: 0, answerSheetImages: 0 },
      },
      warnings: [],
    }),
    reset: vi.fn(),
