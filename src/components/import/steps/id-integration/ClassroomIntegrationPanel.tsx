...
import type { ClassroomMatchingStrategy } from "@/types/examArchive.types"

import { DetailPanel } from "./DetailPanel"
import { StrategyOption } from "./StrategyOption"
import type { ClassroomIntegrationPanelProps } from "./types"
...
export function ClassroomIntegrationPanel({
  ...
  const strategy = state.idIntegrationConfig.classroom
    .strategy as ClassroomMatchingStrategy
      ...
      <Card>
        ...
        <CardContent>
          <RadioGroup
            value={strategy}
            onValueChange={(v) =>
              onStrategyChange(v as ClassroomMatchingStrategy)
            }
          >
