...
const MasterImageViewer = React.memo(
  ({ masterImages, currentQuestionMasterImageId, className }: MasterImageViewerProps) => {
    ...
    const sortedImages = [...masterImages].sort((a, b) => a.pageNumber - b.pageNumber)
          ...
          <ScrollArea className="w-full rounded-md border">
            <div className="flex space-x-3 p-3">
              {sortedImages.map((image) => {
                ...
                const isCurrentQuestion = image.id === currentQuestionMasterImageId
