        ...
        <div className="space-y-6">
          ...
          <div className="border-t pt-4">
            ...
            >
              ...
              <div className="flex items-start space-x-3 p-4 border-2 border-blue-200 bg-blue-50 rounded-lg">
                <RadioGroupItem value="with-scoring" id="with-scoring" className="mt-1" />
                <Label htmlFor="with-scoring" className="flex-1 cursor-pointer">
              ...
              {/* 答案画像のみ入れ替え（警告付き） */}
              <div className="flex items-start space-x-3 p-4 border-2 border-orange-200 bg-orange-50 rounded-lg">
              ...
              <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <div className="mt-3 text-red-800 font-medium">
