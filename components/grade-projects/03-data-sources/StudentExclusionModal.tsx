...
import { useGradeItemExclusions } from "@/hooks/grade-projects/useGradeItemExclusions"
import type { GradeItemWithDetails } from "@/types/gradeProject.types"
...
export function StudentExclusionModal({
  ...
  const { exclusionSet, loading, isExcluded, toggleExclusion } =
    useGradeItemExclusions(gradeProjectId)
