...
import type { GradeDataSourceWithDetails } from "@/types/gradeProject.types"
...
interface DataSourceRowProps {
  ...
  /** 同じGradeProject内の全DataSource（推定ソース選択用） */
...
export function DataSourceRow({
  ...
  // ソース参照先の表示テキスト
  const sourceRef = (() => {
    if (dataSource.examProject) {
      const parts = [dataSource.examProject.examName]
