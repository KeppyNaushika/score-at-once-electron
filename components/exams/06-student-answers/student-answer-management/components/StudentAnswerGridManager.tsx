...
import { GridHeader } from "@/components/exams/06-student-answers/student-answer-management/components/GridHeader"
import { StudentGridRow } from "@/components/exams/06-student-answers/student-answer-management/components/StudentGridRow"
import type {
  UnifiedFile,
  UnifiedStudent,
...
export function StudentAnswerGridManager({
  ...
  useEffect(() => {
    const loadMasterImages = async () => {
      try {
        const images = await window.electronAPI.getExamPagesByExamId(examId)
